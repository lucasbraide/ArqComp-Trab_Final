...
## 77: PC <- PC + 1; MBR <- read_byte(PC) - fetch; goto 19
firmware[77] =   0b01001110_000_00110101_001000_001_001

## 78: MAR <- MBR; read_word(MAR); goto 20
firmware[78] =   0b01001111_000_00010100_100000_010_010
## 4: H <- MDR; goto 5
firmware[79] = 0b01010000_000_00010100_000001_000_000

## 79: X <- X * H; goto 0
firmware[80] =   0b00000000_000_00100000_000100_000_011
