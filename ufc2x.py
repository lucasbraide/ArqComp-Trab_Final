...
firmware[3] = 0b000000101_000_00010100_100000_010_000010

## 4: H <- MDR; goto 5
#firmware[4] = 0b000000101_000_00010100_000001_000_000000

## 5: X <- MDR + X; goto 0
firmware[5] = 0b000000000_000_00111100_000100_000_000011


# X = X - memory[address]

## 6: PC <- PC + 1; fetch; goto 7
firmware[6] = 0b000000111_000_00110101_001000_001_000001

## 7: MAR <- MBR; read; goto 8
firmware[7] = 0b000001001_000_00010100_100000_010_000010

## 8: H <- MDR; goto 9
#firmware[8] = 0b000001001_000_00010100_000001_000_000000

## 9: X <- X - H; goto 0
firmware[9] = 0b000000000_000_00111111_000100_000_000011

# memory[address] = X

## 10: PC <- PC + 1; fetch; goto 11
firmware[10] = 0b00001011_000_00110101_001000_001_000001

## 11: MAR <- MBR; goto 12
firmware[11] = 0b00001100_000_00010100_100000_000_000010

## 12: MDR <- X; write; goto 0
firmware[12] = 0b00000000_000_00010100_010000_100_000011

# goto address 

## 13: PC <- PC + 1; fetch; goto 14
firmware[13] = 0b00001110_000_00110101_001000_001_000001

## 14: PC <- MBR; fetch; goto MBR
firmware[14] = 0b00000000_100_00010100_001000_001_000010

# if X == 0 goto address

## 15: X <- X; if alu = 0 goto 272 else goto 16
firmware[15] = 0b00010000_001_00010100_000100_000_000011

## 16: PC <- PC + 1; goto 0
firmware[16] = 0b00000000_000_00110101_001000_000_000001

## 272: goto 13
firmware[272]= 0b00001101_000_00000000_000000_000_000000
